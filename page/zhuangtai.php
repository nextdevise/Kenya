...
<div class="layuimini-container">
    <div class="layuimini-main">
		...
		<script type="text/html" id="cioncol">
		  <i class="fa {{d.icon}}" style="color:{{d.color}};font-size:26px;"></i>
		</script>
    ...
    layui.use(['form', 'table','soulTable'], function () {
	  ...
	  ,rowDrag: {trigger: 'row', done: function(obj) {
            ...
            cols: [[
				...
				{field: 'icon', width: 200, title: '图标', align: "center", templet:'#cioncol'},
				{field: 'color', width: 200, title: '颜色', align: "center"}
            ]],
