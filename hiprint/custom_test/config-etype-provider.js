            ...
            context.addPrintElementTypes(
                ...
                [
                    new hiprint.PrintElementTypeGroup("常规", [
                        ...
                        {
                            tid: 'configModule.mySite', title: 'QrCode',  text: '二维码',
                            "options": {
                                "height": 50,
                                "width": 50,
                                "fontSize": 19,
                        ...
                        {tid: 'configModule.barcode', text: '条形码', title:'BarCode',
                        "options": {
                            "width": 150, 
                            "height": 15,
                            "textAlign": "center", 
                       ...
                       // { tid: 'configModule.image', title: '图片', data: 'https://zb.kkk.gg/hiprint/', type: 'image' },
                        {tid:"configModule.image",text: '图片', type: 'image', "options":{"field":"","src":"./hi.png"}},
